...
public class Scalr {
     ...
     * @throws IllegalArgumentException
     *                                  if <code>ops</code> is <code>null</code> or
     *                                  empty.
     * @throws ImagingOpException
     *                                  if one of the given {@link BufferedImageOp}s
     *                                  fails to apply.
     *                                  These exceptions bubble up from the inside
     *                                  of most of the
     *                                  {@link BufferedImageOp} implementations and
     *                                  are explicitly
     *                                  defined on the imgscalr API to make it
     *                                  easier for callers to
     *                                  catch the exception (if they are passing
     *                                  along optional ops
     *                                  to be applied). imgscalr takes detailed
     *                                  steps to avoid the
     *                                  most common pitfalls that will cause
     *                                  {@link BufferedImageOp}s
     *                                  to fail, even when using straight forward
     *                                  JDK-image
     *                                  operations.
     */
     ...
     *                                  if <code>src</code> is <code>null</code>.
     * @throws IllegalArgumentException
     *                                  if any coordinates of the bounding crop box
     *                                  is invalid within
     *                                  the bounds of the <code>src</code> image
     *                                  (e.g. negative or
     *                                  too big).
     * @throws ImagingOpException
     *                                  if one of the given {@link BufferedImageOp}s
     ...
     * @param targetSize
     *                   The target width and height (square) that you wish the
     *                   image
     *                   to fit within.
     * @param ops
     *                   <code>0</code> or more optional image operations (e.g.
     *                   sharpen, blur, etc.) that can be applied to the final
     *                   result
     ...
     *                      The image that will be scaled.
     * @param scalingMethod
     *                      The method used for scaling the image; preferring speed
     *                      to
     ...
     *                   given width ({@link Mode#FIT_TO_WIDTH}) or fitting the
     *                   image
     *                   to the given height ({@link Mode#FIT_TO_HEIGHT}). If
     *                   {@link Mode#AUTOMATIC} is passed in, imgscalr will
     *                   calculate
     *                   proportional dimensions for the scaled image based on its
     *                   orientation (landscape, square or portrait). Unless you
     *                   have
     ...
     * @param resizeMode
     *                      Used to indicate how imgscalr should calculate the final
     *                      target size for the image, either fitting the image to
     *                      the
     *                      given width ({@link Mode#FIT_TO_WIDTH}) or fitting the
     *                      image
     *                      to the given height ({@link Mode#FIT_TO_HEIGHT}). If
     *                      {@link Mode#AUTOMATIC} is passed in, imgscalr will
     *                      calculate
     *                      proportional dimensions for the scaled image based on
     *                      its
     *                      orientation (landscape, square or portrait). Unless you
     *                      have
     *                      very specific size requirements, most of the time you
     *                      just
     *                      want to use {@link Mode#AUTOMATIC} to "do the right
     *                      thing".
     * @param targetSize
     *                      The target width and height (square) that you wish the
     *                      image
     ...
     *                 etc.) that can be applied to the final result before
     *                 returning
     *                 the image.
     * 
     ...
     * @see <a
     *      href=
     *      "http://www.mail-archive.com/java2d-interest@capra.eng.sun.com/msg05621.html">How
     ...
     * 
     * @throws IllegalArgumentException
     *                                  if <code>width</code> or <code>height</code>
     *                                  are &lt; 0.
     * 
     * @see <a
     *      href=
     ...
     * @param ratio
     *                     A height/width ratio used to determine the orientation of
     *                     the
     ...
     *                               The {@link RenderingHints} interpolation value
     *                               used to
     *                               indicate the method that {@link Graphics2D}
     *                               should use when
     *                               scaling the image.
     * 
     ...
     *                               The target height for the scaled image.
     * @param scalingMethod
     *                               The scaling method specified by the user (or
     *                               calculated by
     *                               imgscalr) to use for this incremental scaling
     *                               operation.
     * @param interpolationHintValue
     *                               The {@link RenderingHints} interpolation value
     *                               used to
