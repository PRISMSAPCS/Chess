...
public class BitBoardBitManipulation {
	 ...
	 * 0000 0000 0000 0000 0000 0000 0011 1111 0000 0000 0000 0000 0000 0000 0000 0000	depth
	 * 0000 0000 0000 0000 0000 0000 1100 0000 0000 0000 0000 0000 0000 0000 0000 0000	flag type
	 * 0000 0000 0000 0000 1111 1111 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000	generation
	 * 1111 1111 1111 1111 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000	unused
	 */
	
	public static long encodeEntryData(int Depth, int Flag, short Score, short Move, byte generation) {
		return	((long) Depth << 32) 
				| ((long) Flag << 38)
				| (Short.toUnsignedLong(Score) << 16) 
				| Short.toUnsignedInt(Move)
				| (Byte.toUnsignedInt(generation) << 40);
	}
	...
	public static int getEntryDepth(long entry) { return (int) ((entry >>> 32) & 0x3F); }
	public static int getEntryFlag(long entry) { return (int) ((entry >>> 38) & 0x3); }
	public static byte getEntryGeneration(long entry) { return (byte) ((entry >>> 40) & 0xFF); }
}